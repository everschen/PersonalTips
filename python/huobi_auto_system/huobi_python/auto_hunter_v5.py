...
first_buy_price_threshold = 999999999

quick_sell_flag = False
...
if __name__ == '__main__':
    ...
    help_str = "auto_hunter_v5.py -b <diff_space_buy %> -a <accu_buy % > -s <diff_space_sell % > -l <last_times> -d <deal_space % > -u <usdt_amount> -y <symbol> -p <price_list> -t <total_buy_times>"
