# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 23:05:54 2015
...
def my_calc(code,times,dowj,news):
    ...
    max_nums = 0
    max_info = ""
    S_days_high,S_days_low,S_days_max,S_days_min = calc_X_days_average(df, 90)
...
#    print X_days_low
    ...
    S_days_info = "<br><font size='3'> 90 days average: %.2f, %.2f --> %.2f, %.2f</font>"%(S_days_min,S_days_low,S_days_high,S_days_max)
    ...
    for i in floatrange(low_30, high_30, step):
        buy = round(i,2)
    ...
    send_email(code+" "+code_name + " " + today, Current_info + trade_info + max_info + S_days_info + M_days_info + T_days_info + F_days_info + Hist_info + dd + content)
...
codes=['600588','002439','600718','600845','600050','000063','002769','600663','002242']

#codes.extend(['002242','600100','601766','600050','000063','000938']) #my stock
#codes=['600050']

mycodes = ['000063','600050','000938']
times =1
dowj = -0.0284
dowj = 0
...
myselect = []
for i in range(0, len(df)):
    if (df.irow(i).totalAssets > 1000000 and df.irow(i).totalAssets < 9000000 and df.irow(i).name[0]!='3' and df.irow(i).esp > 1.0 ) :
