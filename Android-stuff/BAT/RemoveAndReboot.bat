...
adb -s %mydevice2% shell rm -rf /data/slog/*
adb -s %mydevice2% shell rm -rf /data/slog/*.*
adb -s %mydevice2% shell rm -rf /data/ylog/ylog/*
adb -s %mydevice2% shell rm -rf /data/ylog/ylog/*.*
adb -s %mydevice2% shell rm -rf /data/ylog/last_ylog/*
adb -s %mydevice2% shell rm -rf /data/ylog/last_ylog/*.*
adb -s %mydevice2% shell rm -rf /data/modem_log/*
adb -s %mydevice2% shell rm -rf /data/modem_log/*.*
