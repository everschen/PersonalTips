...
cd e:\log
set handover=modem
md %ymd%-%hour%%ms%-%mydevice2%-%handover%
cd %ymd%-%hour%%ms%-%mydevice2%-%handover%
...
adb -s %mydevice2% pull /data/modem_log/ modem_log_in/
adb -s %mydevice2% pull storage/sdcard0/modem_log/ modem_log/
